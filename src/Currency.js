...
export async function getCoinPriceFromAPI() {
    ...
    let uri = `${Config.priceApiLink}?ids=${Config.coinNamePriceApi.toLowerCase()}&vs_currencies=${getCurrencyTickers()}`;
    ...
    try {
        ...
        const coinData = data[Config.coinNamePriceApi.toLowerCase()];
